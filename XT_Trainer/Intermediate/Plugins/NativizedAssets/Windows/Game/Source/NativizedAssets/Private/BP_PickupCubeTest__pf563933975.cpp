...
ABP_PickupCubeTest_C__pf563933975::ABP_PickupCubeTest_C__pf563933975(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	if(__Local__0)
	{
		...
		__Local__1 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_PickupCubeTest_C__pf563933975::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
		...
		__Local__0->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_PickupCubeTest_C__pf563933975::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	...
	bpv__FirstHandAtached__pf = false;
	bpv__secondHandAtached__pf = false;
	bpv__firstHand__pf = nullptr;
	bpv__secondHand__pf = nullptr;
...
void ABP_PickupCubeTest_C__pf563933975::bpf__ExecuteUbergraph_BP_PickupCubeTest__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	bpfv__CallFunc_BooleanAND_ReturnValue__pf = UKismetMathLibrary::BooleanAND(bpv__FirstHandAtached__pf, bpv__secondHandAtached__pf);
	if (!bpfv__CallFunc_BooleanAND_ReturnValue__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(bpv__secondHand__pf);
	if (!bpfv__CallFunc_IsValid_ReturnValue__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	if(::IsValid(bpv__firstHand__pf))
	{
		bpfv__CallFunc_K2_GetComponentRotation_ReturnValue__pf = bpv__firstHand__pf->USceneComponent::K2_GetComponentRotation();
	}
	...
	if(::IsValid(bpv__firstHand__pf))
	{
		bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf = bpv__firstHand__pf->USceneComponent::K2_GetComponentLocation();
	}
	if(::IsValid(bpv__secondHand__pf))
	{
		bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_1__pf = bpv__secondHand__pf->USceneComponent::K2_GetComponentLocation();
	}
	bpfv__CallFunc_FindLookAtRotation_ReturnValue__pf = UKismetMathLibrary::FindLookAtRotation(bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_1__pf);
	...
	bpfv__CallFunc_MakeRotator_ReturnValue__pf = UKismetMathLibrary::MakeRotator(b0l__CallFunc_BreakRotator_Roll__pf, b0l__CallFunc_BreakRotator_Pitch_1__pf, b0l__CallFunc_BreakRotator_Yaw_1__pf);
	if(::IsValid((*(AccessPrivateProperty<UStaticMeshComponent* >((this), AStaticMeshActor::__PPO__StaticMeshComponent() )))))
	{
		(*(AccessPrivateProperty<UStaticMeshComponent* >((this), AStaticMeshActor::__PPO__StaticMeshComponent() )))->USceneComponent::K2_SetWorldRotation(bpfv__CallFunc_MakeRotator_ReturnValue__pf, false, /*out*/ b0l__CallFunc_K2_SetWorldRotation_SweepHitResult__pf, false);
	}
...
void ABP_PickupCubeTest_C__pf563933975::bpf__ExecuteUbergraph_BP_PickupCubeTest__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 5:
			{
				bpv__FirstHandAtached__pf = true;
			}
		case 6:
			{
				bpv__secondHandAtached__pf = false;
		...
		case 7:
			{
				bpv__firstHand__pf = b0l__K2Node_Event_AttachTo__pf;
				__CurrentState = -1;
				break;
			}
		case 8:
			{
				if (!bpv__FirstHandAtached__pf)
				{
					__CurrentState = 12;
					break;
				}
		...
		case 9:
			{
				bpfv__CallFunc_NotEqual_ObjectObject_ReturnValue__pf = UKismetMathLibrary::NotEqual_ObjectObject(b0l__K2Node_Event_AttachTo__pf, bpv__firstHand__pf);
		...
		case 10:
			{
				bpv__secondHandAtached__pf = true;
			}
		case 11:
			{
				bpv__secondHand__pf = b0l__K2Node_Event_AttachTo__pf;
				__CurrentState = -1;
				break;
			}
		case 12:
...
{
	bpf__ExecuteUbergraph_BP_PickupCubeTest__pf_2(14);
}
void ABP_PickupCubeTest_C__pf563933975::bpf__Pickup__pf(USceneComponent* bpp__AttachTo__pf)
{
	...
	bpf__ExecuteUbergraph_BP_PickupCubeTest__pf_1(15);
}
void ABP_PickupCubeTest_C__pf563933975::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_BP_PickupCubeTest__pf_0(16);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_PickupCubeTest_C__pf563933975::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{102, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Game/Geometry/Meshes/CubeMaterial.CubeMaterial 
	};
