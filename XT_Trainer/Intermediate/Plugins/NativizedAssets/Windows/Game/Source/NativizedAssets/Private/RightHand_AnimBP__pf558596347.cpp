...
void URightHand_AnimBP_C__pf558596347::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__7.CopyRecords = TArray<FExposedValueCopyRecord> ();
	__Local__7.CopyRecords.AddUninitialized(1);
	FExposedValueCopyRecord::StaticStruct()->InitializeStruct(__Local__7.CopyRecords.GetData(), 1);
	auto& __Local__8 = __Local__7.CopyRecords[0];
	__Local__8.SourcePropertyName = FName(TEXT("Grip"));
	__Local__8.DestProperty = TEXT("/Script/AnimGraphRuntime.AnimNode_BlendSpacePlayer:X");
	__Local__8.Size = 4;
	__Local__8.CachedSourceProperty = TEXT("/Game/VirtualReality/Mannequin/Animations/RightHand_AnimBP.RightHand_AnimBP_C:Grip");
	...
	__Local__0->ResolvePropertyPaths();
...
void URightHand_AnimBP_C__pf558596347::bpf__ExecuteUbergraph_RightHand_AnimBP__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	bpv__HandEnum__pf = ((::IsValid(b0l__K2Node_DynamicCast_AsBP_Motion_Controller__pf)) ? (b0l__K2Node_DynamicCast_AsBP_Motion_Controller__pf->bpv__Hand__pf) : (__Local__9));
	return; // KCST_GotoReturn
}
...
void URightHand_AnimBP_C__pf558596347::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{90, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  ScriptStruct /Script/AnimGraphRuntime.AnimNode_BlendSpacePlayer 
		...
		{83, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.AnimInstance 
		...
		{92, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  ScriptStruct /Script/Engine.AnimNode_Root 
