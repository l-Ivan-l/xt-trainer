...
public:
	...
	UPROPERTY(Transient, DuplicateTransient, meta=(OverrideNativeName="CallFunc_ShouldUpdateFacingDirection_ShouldAdjust_1"))
	bool b0l__CallFunc_ShouldUpdateFacingDirection_ShouldAdjust_1__pf;
	...
	UPROPERTY(Transient, DuplicateTransient, meta=(OverrideNativeName="CallFunc_GetOrientationAndPosition_DeviceRotation_1"))
	FRotator b0l__CallFunc_GetOrientationAndPosition_DeviceRotation_1__pf;
	UPROPERTY(Transient, DuplicateTransient, meta=(OverrideNativeName="CallFunc_GetOrientationAndPosition_DevicePosition_1"))
	FVector b0l__CallFunc_GetOrientationAndPosition_DevicePosition_1__pf;
	...
	UFUNCTION(meta=(OverrideNativeName="InpActEvt_R_K2Node_InputKeyEvent_0"))
	virtual void bpf__InpActEvt_R_K2Node_InputKeyEvent_0__pf(FKey bpp__Key__pf);
	UFUNCTION(meta=(OverrideNativeName="InpActEvt_HMDTeleport_K2Node_InputActionEvent_0"))
	virtual void bpf__InpActEvt_HMDTeleport_K2Node_InputActionEvent_0__pf(FKey bpp__Key__pf);
	UFUNCTION(meta=(OverrideNativeName="InpActEvt_HMDTeleport_K2Node_InputActionEvent_1"))
	virtual void bpf__InpActEvt_HMDTeleport_K2Node_InputActionEvent_1__pf(FKey bpp__Key__pf);
