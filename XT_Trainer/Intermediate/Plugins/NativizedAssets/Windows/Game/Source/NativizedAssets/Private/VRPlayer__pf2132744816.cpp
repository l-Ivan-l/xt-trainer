...
#include "VRPlayer__pf2132744816.h"
...
AVRPlayer_C__pf2132744816::AVRPlayer_C__pf2132744816(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__RightHandMC__pf = CreateDefaultSubobject<UMotionControllerComponent>(TEXT("RightHandMC"));
	bpv__RHandMesh__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("RHandMesh"));
	...
	(((FBoolProperty*)__Local__12)->SetPropertyValue_InContainer((bpv__Root__pf), false, 0));
	bpv__Camera__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Camera__pf->AttachToComponent(bpv__Root__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__14 = (*(AccessPrivateProperty<FVector >((bpv__Camera__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__14 = FVector(0.000000, 0.000000, -90.000000);
	(((FBoolProperty*)__Local__12)->SetPropertyValue_InContainer((bpv__Camera__pf), false, 0));
	bpv__RightHandMC__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__RightHandMC__pf->AttachToComponent(bpv__Root__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__RightHandMC__pf->MotionSource = FName(TEXT("Right"));
	auto& __Local__15 = (*(AccessPrivateProperty<FVector >((bpv__RightHandMC__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__15 = FVector(0.000000, 0.000000, -90.000000);
	(((FBoolProperty*)__Local__12)->SetPropertyValue_InContainer((bpv__RightHandMC__pf), false, 0));
	bpv__RHandMesh__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__RHandMesh__pf->AttachToComponent(bpv__RightHandMC__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__16 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__RHandMesh__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__16 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AVRPlayer_C__pf2132744816::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__17 = (*(AccessPrivateProperty<FVector >((bpv__RHandMesh__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__17 = FVector(0.100000, 0.100000, 0.100000);
	(((FBoolProperty*)__Local__12)->SetPropertyValue_InContainer((bpv__RHandMesh__pf), true, 0));
	auto& __Local__18 = (*(AccessPrivateProperty<USkeletalMeshComponent*>((this), ACharacter::__PPO__Mesh() )));
	__Local__18 = __Local__2;
	auto& __Local__19 = (*(AccessPrivateProperty<UCharacterMovementComponent*>((this), ACharacter::__PPO__CharacterMovement() )));
	__Local__19 = __Local__1;
	auto& __Local__20 = (*(AccessPrivateProperty<UCapsuleComponent*>((this), ACharacter::__PPO__CapsuleComponent() )));
...
void AVRPlayer_C__pf2132744816::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__RightHandMC__pf)
	{
		bpv__RightHandMC__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__RHandMesh__pf)
	{
		bpv__RHandMesh__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void AVRPlayer_C__pf2132744816::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	(((FBoolProperty*)__Local__23)->SetPropertyValue_InContainer((__Local__22), false, 0));
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AVRPlayer_C__pf2132744816::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AVRPlayer_C__pf2132744816::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{69, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/HeadMountedDisplay.MotionControllerComponent 
		...
		{113, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.Character 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AVRPlayer_C__pf2132744816
{
	FRegisterHelper__AVRPlayer_C__pf2132744816()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/BluePrints/VRPlayer"), &AVRPlayer_C__pf2132744816::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AVRPlayer_C__pf2132744816 Instance;
};
FRegisterHelper__AVRPlayer_C__pf2132744816 FRegisterHelper__AVRPlayer_C__pf2132744816::Instance;
