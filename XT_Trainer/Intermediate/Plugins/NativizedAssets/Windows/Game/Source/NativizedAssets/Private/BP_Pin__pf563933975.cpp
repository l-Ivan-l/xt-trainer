...
ABP_Pin_C__pf563933975::ABP_Pin_C__pf563933975(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	if(__Local__0)
	{
		...
		__Local__1 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_Pin_C__pf563933975::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
		...
		__Local__0->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_Pin_C__pf563933975::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
		...
		__Local__0->SetCollisionProfileName(FName(TEXT("OverlapAllDynamic")));
	...
	{
		__Local__8 = (AActor::StaticClass())->FindPropertyByName(FName(TEXT("bCanBeDamaged")));
		check(__Local__8);
		__Local__9 = __Local__8;
	}
	(((FBoolProperty*)__Local__8)->SetPropertyValue_InContainer((this), true, 0));
...
void ABP_Pin_C__pf563933975::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Pin_C__pf563933975::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ABP_Pin_C__pf563933975::bpf__ExecuteUbergraph_BP_Pin__pf_0(int32 bpp__EntryPoint__pf)
{
...
void ABP_Pin_C__pf563933975::bpf__ExecuteUbergraph_BP_Pin__pf_1(int32 bpp__EntryPoint__pf)
{
...
void ABP_Pin_C__pf563933975::bpf__Drop__pf()
{
	bpf__ExecuteUbergraph_BP_Pin__pf_0(4);
}
void ABP_Pin_C__pf563933975::bpf__Pickup__pf(USceneComponent* bpp__AttachTo__pf)
{
	b0l__K2Node_Event_AttachTo__pf = bpp__AttachTo__pf;
	bpf__ExecuteUbergraph_BP_Pin__pf_1(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Pin_C__pf563933975::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Pin_C__pf563933975::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_Pin_C__pf563933975
{
	FRegisterHelper__ABP_Pin_C__pf563933975()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/VirtualRealityBP/Blueprints/BP_Pin"), &ABP_Pin_C__pf563933975::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_Pin_C__pf563933975 Instance;
};
FRegisterHelper__ABP_Pin_C__pf563933975 FRegisterHelper__ABP_Pin_C__pf563933975::Instance;
